<?php
function rp_view_single_record_by_id_frontend($atts) {
	...
	if (isset($atts)) { 
		...
		$rpdb . "rp_grade " . $rpdb . "rp_1, " . $rpdb . "rp_grade " . $rpdb . "rp_2, " . $rpdb . "rp_grade " . $rpdb . "rp_3, " . $rpdb . "rp_format WHERE " . $rpdb . "rp_records.id = " . $atts['id'] . " AND " . $rpdb . "rp_records.recordgrade = " . 
...
add_shortcode('rp_view_single_record_by_id','rp_view_single_record_by_id_frontend');
?>